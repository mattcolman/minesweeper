...
var Game = (function () {
  ...
  Game.prototype.createBlocks = function createBlocks() {
    ...
    var blockWidth = $("#game span").outerWidth(true);
  ...
  Game.prototype.getXY = function getXY(block) {
    ...
    var x = _block$id$split2[0];
    var y = _block$id$split2[1];
...
},{"./grid":16,"bootstrap":1,"lodash":14}],16:[function(require,module,exports){
'use strict';
...
},{"lodash":14}],17:[function(require,module,exports){
/**
 * @author Matt Colman
 */
